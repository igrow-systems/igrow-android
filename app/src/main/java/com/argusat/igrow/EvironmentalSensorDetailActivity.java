 ...
 * more than a {@link EvironmentalSensorDetailFragment}.
 */
public class EvironmentalSensorDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(EvironmentalSensorDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(EvironmentalSensorDetailFragment.ARG_ITEM_ID));
            EvironmentalSensorDetailFragment fragment = new EvironmentalSensorDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.evironmentalsensor_detail_container, fragment)
                    .commit();
        }
    }
