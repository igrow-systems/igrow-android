...
public class EnvironmentalSensorListAdapter extends RecyclerView.Adapter<EnvironmentalSensorListAdapter.ViewHolder> {
    ...
    public EnvironmentalSensorListAdapter(String[] myDataset) {
        mDataset = myDataset;
    }
