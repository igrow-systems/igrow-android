...
public class EnvironmentalSensorRecyclerViewFragment extends Fragment {
    ...
    protected EnvironmentalSensorListViewModel mSensorListViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mSensorListViewModel = ViewModelProviders.of(this).get(EnvironmentalSensorListViewModel.class);
        mSensorListViewModel.init("DUMMY_USERID");
        mSensorListViewModel.getEnvironmentalSensorList().observe(this, sensorList -> {
            // update UI
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mListAdapter = new EnvironmentalSensorListAdapter(mSensors,
                new EnvironmentalSensorListAdapter.OnItemClickListener() {
            @Override
